      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="alert alert-sm alert-success">
              <strong>Success!</strong> Selamat Datang <b><?php echo $p['nama_pelanggan']; ?></b>.
                      ...
                      <div class="row align-items-center h-100">
                        <div class="col-md-4">
                          <figure class="avatar mx-auto mb-4 mb-md-0">
                            <img src="pelanggan1/<?php echo $p['foto']; ?>" alt="avatar">
                          </figure>
                        </div>
                        <div class="col-md-8">
                          <h5 class="text-white text-center text-md-left"><?php echo $p['nama_pelanggan']; ?></h5>
                          <p class="text-white text-center text-md-left"><?php echo $p['email']; ?></p>
                          <div class="d-flex align-items-center justify-content-between info pt-2">
                            <div>
                              <p class="text-white font-weight-bold">Wa</p>
                              <p class="text-white font-weight-bold">Alamat</p>
                            </div>
                            <div>
                              <p class="text-white"><?php echo $p['nomor_hp']; ?></p>
                              <p class="text-white"><?php echo $p['alamat']; ?></p>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div style="overflow-x: auto; overflow-y: auto; max-height: 300px;">
            <table class="table table-striped">
              ...
              <tbody>
                <?php 
                $i = mysqli_query($koneksi, "SELECT * FROM tb_item");
                while ($ri = mysqli_fetch_assoc($i)){
                ?>
                <tr style="text-align: justify;">
                  <td><?php echo $ri['nama_item']; ?></td>
                  <td><?php echo $ri['deskripsi_item']; ?></td>
                  <td><?php echo "Rp. " .number_format($ri['harga_peritem']). ",-"; ?></td>
                </tr>
                <?php } ?>
              </tbody>
          </table>
