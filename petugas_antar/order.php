                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php 
                          $dataK = "SELECT * FROM tb_karyawan WHERE jabatan='Petugas Antar' AND id_karyawan='$kurir'";
                          $resultK = mysqli_query($koneksi, $dataK);
                          while($rowK = mysqli_fetch_assoc($resultK)){
                          ?>
                          <small style="font-size: 13px;" >Yang Mengantar: <span class="badge badge-dark"><?php echo $rowK['nama_karyawan']; ?></span></small>
                          <?php } ?>
                        </td>
                        <td>
                          <?php if ($status == 6) { ?>
                          ...
                          <div class="modal fade" id="myModal<?php echo $odr['id_order']; ?>">
                            ...
                            <select class="form-control" name="status">
                              ...
                              <option <?php if ($status == "7"){echo "selected='selected'";} ?> value="7">Diantar</option>
                              <option <?php if ($status == "8"){echo "selected='selected'";} ?> value="8">Selesai Diantar</option>
                            </select>
                                              </div>
                                              <!-- Modal Footer -->
