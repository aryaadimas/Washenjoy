                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      <?php
                        $no=1; 
                        $dataO = "SELECT * FROM tb_order, tb_pelanggan WHERE id_pelanggan=pel_id AND kar_id='$idk' ORDER BY id_order DESC";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php 
                          $dataK = "SELECT * FROM tb_karyawan WHERE jabatan='Pencucian' AND id_karyawan='$kar'";
                          $resultK = mysqli_query($koneksi, $dataK);
                          while($rowK = mysqli_fetch_assoc($resultK)){
                          ?>
                          <small style="font-size: 12px;">Tugas Yang Mencuci: <span class="badge badge-dark"><?php echo $rowK['nama_karyawan']; ?></span></small>
                          <?php } ?>
                        </td>
                        <td>
                          <?php if ($status == 3) { ?>
                          ...
                          <div class="modal fade" id="myModal<?php echo $odr['id_order']; ?>">
                            ...
                            <select class="form-control" name="status">
                              ...
                              <option <?php if ($status == "4"){echo "selected='selected'";} ?> value="4">Antrian</option>
                              <option <?php if ($status == "5"){echo "selected='selected'";} ?> value="5">Proses laundry</option>
                              <option <?php if ($status == "6"){echo "selected='selected'";} ?> value="6">Selesai</option>
                            </select>
                                              </div>
                                              <!-- Modal Footer -->
