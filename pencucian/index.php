          ...
          <div class="row mb-3">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <?php 
                      $dataP = "SELECT count(*) as total FROM tb_pelanggan";
                      $resultP = mysqli_query($koneksi, $dataP);
                      $rowP = mysqli_fetch_assoc($resultP);
                      ?>
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Pelanggan</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $rowP['total']; ?></div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <?php 
                      $dataO = "SELECT count(*) as total FROM tb_order";
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $rowO['total']; ?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                      </div>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <?php 
                      $dataK = "SELECT count(*) as total FROM tb_karyawan";
                      $resultK = mysqli_query($koneksi, $dataK);
                      $rowK = mysqli_fetch_assoc($resultK);
                      ?>
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Keryawan</div>
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $rowK['total']; ?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-12 col-lg-7 mb-4">
                <div class="alert alert-sm alert-success">
                  <strong>Success!</strong> Selamat Datang <b><?php echo $_SESSION['nama_kar']; ?></b>.
